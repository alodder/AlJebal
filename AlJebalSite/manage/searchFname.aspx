<%@ Page Title="" Language="C#" MasterPageFile="~/manage/MasterPage.master" AutoEventWireup="true" CodeFile="searchFname.aspx.cs" Inherits="manage_Default2" %>
    ...
    <table style="width:100%;">
        <tr>
            ...
            <td class="style2">
                <asp:Label ID="Label1" runat="server" 
                    Text="You can look for table reservation by customer First name"></asp:Label>
            </td>
            <td>
                &nbsp;</td>
            <td>
        ...
        <tr>
            <td class="style5">
                &nbsp;</td>
            <td class="style3">
                <asp:Label ID="Label2" runat="server" Text="Put Customer First name here :"></asp:Label>
            </td>
            <td class="style1">
        ...
        <tr>
            ...
            <td class="style2">
                <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" 
                    ...
                    <Fields>
                        ...
                        <asp:BoundField DataField="ResTimeDate" HeaderText=" Time Date for the reservation" 
                        ...
                        <asp:BoundField DataField="DWTRA" 
                            HeaderText="do the customer want to recive add email " SortExpression="DWTRA" />
                    </Fields>
            ...
            <td>
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    SelectCommand="byfirstname" SelectCommandType="StoredProcedure">
                    <SelectParameters>
