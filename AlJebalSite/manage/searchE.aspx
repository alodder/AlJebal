<%@ Page Title="" Language="C#" MasterPageFile="~/manage/MasterPage.master" AutoEventWireup="true" CodeFile="searchE.aspx.cs" Inherits="manage_Default2" %>
    ...
    <table style="width:100%;">
        <tr>
            ...
            <td class="style2">
                <asp:Label ID="Label1" runat="server" 
                    Text="You can look for table reservation by customer email"></asp:Label>
            </td>
            <td>
                &nbsp;</td>
            <td>
        ...
        <tr>
            <td class="style5">
                &nbsp;</td>
            <td class="style3">
                <asp:Label ID="Label2" runat="server" Text="Put Customer email here :"></asp:Label>
            </td>
            <td class="style1">
            ...
            <td class="style2">
                <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" 
                    ...
                    <Fields>
                        ...
                        <asp:BoundField DataField="ResTimeDate" HeaderText="Reservation Time Date" 
